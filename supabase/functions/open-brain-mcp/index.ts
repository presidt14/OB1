// ============================================================
// Open Brain — open-brain-mcp/index.ts
// Supabase Edge Function: MCP server with 4 tools
// Deploy: supabase functions deploy open-brain-mcp --no-verify-jwt
//
// Requires deno.json in same directory (see deno.json.example)
// ============================================================
...
server.registerTool(
  "search_thoughts",
  {
    ...
    description: "Search captured thoughts by meaning. Use when the user asks about a topic, person, or idea they've previously captured.",
    inputSchema: {
...
server.registerTool(
  "capture_thought",
  {
    ...
    description: "Save a new thought to the Open Brain from any MCP-connected AI client. Generates embedding and extracts metadata automatically.",
    inputSchema: {
...
// ── Hono app with key auth ──────────────────────────────────────────
const app = new Hono();

app.all("*", async (c) => {
  // Accept key via header OR URL query param
