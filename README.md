...
| ------------ | ------------ | ------- |
| [MCP OAuth Proxy — Cloudflare Worker for connector sign-in failures](integrations/mcp-oauth-proxy/) | MCP OAuth Proxy — Cloudflare Worker for connector sign-in failures. | [@presidt14](https://github.com/presidt14) |
| [Sync open-brain-mcp Edge Function with the hardened implementation](supabase/functions/open-brain-mcp/index.ts) | Sync open-brain-mcp Edge Function with the hardened implementation. | [@presidt14](https://github.com/presidt14) |
